...
/********************************************** 
  ...
  -> 함수 바깥쪽에 선언해준다!
  (goSlide함수를 바깥에 선언함! let goSlide;)
...
function goDrag(obj) {
  ...
  const dMove = () => {
    ...
    if (drag) {
      ...
      // 모바일에서는 위치값을 changeTouches 컬렉션에 수집한다!
