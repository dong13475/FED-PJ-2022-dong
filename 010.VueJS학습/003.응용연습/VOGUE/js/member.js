...
$(()=>{
  ...
  *************************************************/
  $("#email1,#email2").on("keyup",function(){
    ...
    // 현재 아이디가 "email1"인가? 맞으면 선택박스
    // 아니면 두번째 이메일뒷주소를 입력하는 중이므로 
    // 그것을 선택
    // 변수 = 조건연산자
    // 변수 = 조건식?값1:값2
  ...
  *******************************************/
  ...
  // action 설정 페이지로 모든 입력창의 값을 전송하도록
  // 설계되어 있다!
  // 기본 서브밋 이동을 막고 우리가 검사후 전송한다!
  $("#btnj").click(e=>{
    // 호출확인
    console.log("가입해");
